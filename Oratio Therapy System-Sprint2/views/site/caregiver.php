                      ...
                      <div class="u-align-left u-container-style u-layout-cell u-opacity u-opacity-70 u-radius-20 u-size-60 u-layout-cell-1">
                        ...
                        <?= Html::img(Url::to('@web/css_a/images_a/Caregiver-2.png'), ['alt' => 'My logo',
                         'class' => 'u-image u-image-1'
                          ...
                          <h3 class="u-align-left u-text u-text-4" data-animation-direction="" data-animation-name="customAnimationIn" data-animation-duration="1000" data-animation-delay="0" data-animation-out="0">Cellulare:<?= \Yii::$app->user->identity->cell ?>&nbsp;</h3>
                        </div>
                      </div>
                    </div>
                  </div>
